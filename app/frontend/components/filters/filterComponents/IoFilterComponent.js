...
class IoFilterComponent extends Component {
    constructor(props) {
        super(props);
        this.state = {
            type: "",
        ...
        return (
            <View style={{ width: '100%', height: '70%', padding: 15 }}>
                ...
                <View style={{ flex: 1, backgroundColor: '#eee', borderRadius: 6, alignItems: 'center', justifyContent: 'center' }}>
                    <View style={{ width: '90%', height: '60%', marginVertical: 15, flexDirection: 'column', borderRadius: 10, justifyContent: 'center' }}>
...
export default IoFilterComponent;
