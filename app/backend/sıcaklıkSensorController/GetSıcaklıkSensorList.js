...
export const GetSıcaklıkSensor = async (x, start, length, refreshPage) => {
    ...
    var URL = url + '/temperatureSensors' + '?start=' + start + '&length=' + length + '&filter[measuring_location_name]=' + location + '&filter[comm_device_id]=' + device_id + '&filter[measuring_device_id]=' + mesauringDevice
    console.log(URL)
    ...
    return fetch(URL, {
        ...
        .then((responseJson) => {
            ...
            x.setState({
                SıcaklıkSensorSayisi: responseJson.Data.records_total,
                dataLoading: false
            });
            ...
            responseJson.Data.data.forEach(element => {
                ...
                if (element.measuring_location_name == null && element.measuring_location_name == '') {
