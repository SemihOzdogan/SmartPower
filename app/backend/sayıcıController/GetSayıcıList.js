...
export const GetSayıcı = async (x, start, length, refreshPage) => {
    ...
    var URL = url + '/pulseCounters' + '?start=' + start + '&length=' + length + '&filter[measuring_location_name]=' + location + '&filter[comm_device_id]=' + device_id + '&filter[measuring_device_id]=' + mesauringDevice
    console.log(URL)
    ...
    return fetch(URL, {
        ...
        .then((responseJson) => {
            ...
            x.setState({
                SayıcıSayisi: responseJson.Data.records_total,
                dataLoading: false
            });
